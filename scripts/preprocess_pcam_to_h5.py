...
def main():
    ...
    parser = argparse.ArgumentParser(description="Preprocess PCam and write new H5 files.")
    parser.add_argument("--data-dir", type=str, default=None,
                        help="Path to pcam_data (default: PROJECT_ROOT/pcam_data)")
    ...
    print("Preprocessing PCam: Step 1 (quality) -> Step 2 (stain norm) -> Step 3 (value [0,1])")
