...
Material kept for reference but **outside the main Q1 reproduction path**. Nothing here is required to regenerate manuscript figures in `notebooks/figure*.ipynb` or final results in `docs/final_*.md`.

| Folder | Contents |
|--------|----------|
| `graduation/` | Thesis PDFs, poster/presentation notebooks, slide figures, title options |
